...
clang_tidy_aspect = aspect(
    ...
    attrs = {
        ...
        "_clang_tidy_wrapper": attr.label(default = Label("//bazel/clang_tidy:clang_tidy")),
        "_clang_tidy_executable": attr.label(default = Label("//bazel/clang_tidy:clang_tidy_executable")),
        "_clang_tidy_additional_deps": attr.label(default = Label("//bazel/clang_tidy:clang_tidy_additional_deps")),
